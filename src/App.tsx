  ...
  return (
    <div className="min-h-screen bg-black/95 text-white">
      <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 xl:px-10 2xl:px-12 py-10 lg:py-14 flex flex-col gap-8 lg:gap-10">
        <div className="flex flex-col sm:flex-row items-stretch gap-5 sm:gap-6 lg:gap-7 xl:gap-8">
          <div className="flex-1 basis-0 sm:flex-[0.4] flex">
            <DataInput accounts={accounts} onChange={updateAccount} usdPln={usdPln} />
          </div>
          <div className="flex-1 basis-0 sm:flex-[0.6] flex">
