    ...
    <div className="space-y-2">
      ...
      <div className="relative group">
        <input
          ...
          className="w-full rounded-2xl border border-white/12 bg-black/45 px-4 py-3 text-lg text-white placeholder:text-white/55 shadow-[0_10px_30px_rgba(0,0,0,0.45)] backdrop-blur focus:border-lime-200/80 focus:outline-none focus:ring-2 focus:ring-lime-200/60 transition-all duration-200 group-hover:border-white/25 caret-white [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
          placeholder="0.00"
          aria-label={label}
        />
      </div>
